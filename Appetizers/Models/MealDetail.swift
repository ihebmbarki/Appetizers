...
struct MealDetail: Decodable, Identifiable {
    ...
    // Keep all 20 pairs for full API compatibility
    ...
    /// Combine ingredients + measures into a clean list
    var ingredients: [String] {
        ...
        return ingredientsArray.compactMap { ingredient, measure in
            ...
            return measureText.isEmpty ? ingredient : "\(ingredient) - \(measureText)"
        }
    }
}
